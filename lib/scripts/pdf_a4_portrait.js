...
function renderNow () {
  ...
  var height = page.evaluate(function () { return document.getElementById('print').offsetHeight }),
    width = page.evaluate(function () { return document.getElementById('print').offsetWidth });

  // Output to parent process
  system.stdout.write(JSON.stringify({ filename: filename, height: height, width: width }))
  exit(null)
}
