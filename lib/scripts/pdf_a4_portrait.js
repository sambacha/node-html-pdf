...
if (options.settings) {
  if (options.settings.javascriptEnabled) page.settings.javascriptEnabled = !!options.settings.javascriptEnabled
  if (options.settings.loadImages) page.settings.loadImages = !!options.settings.loadImages
  if (options.settings.localToRemoteUrlAccessEnabled) page.settings.localToRemoteUrlAccessEnabled = !!options.settings.localToRemoteUrlAccessEnabled
  if (options.settings.userAgent) page.settings.userAgent = !!options.settings.userAgent
  if (options.settings.userName) page.settings.userName = !!options.settings.userName
  if (options.settings.password) page.settings.password = !!options.settings.password
  if (options.settings.XSSAuditingEnabled) page.settings.XSSAuditingEnabled = !!options.settings.XSSAuditingEnabled
  if (options.settings.webSecurityEnabled) page.settings.webSecurityEnabled = !!options.settings.webSecurityEnabled
  if (options.settings.resourceTimeout) page.settings.resourceTimeout = !!options.settings.resourceTimeout
